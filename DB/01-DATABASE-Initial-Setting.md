...
select name, Countrycode, Population
from city 
where Population BETWEEN 8000000 AND 9000000;select name, Countrycode, Population
from city 
where Population >= 10000000;
...
# 결과에서 인구수순으로 내림차순으로 정렬
SELECT *
FROM city
ORDER BY ContryCode ASC, Population DESC;
